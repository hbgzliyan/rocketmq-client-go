...
//go:generate mockgen -source offset_store.go -destination mock_offset_store.go -self_package github.com/hbgzliyan/rocketmq-client-go/v2/consumer  --package consumer OffsetStore
