...
//go:generate mockgen -source client.go -destination mock_client.go -self_package github.com/hbgzliyan/rocketmq-client-go/v2/internal  --package internal RMQClient
