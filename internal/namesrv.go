...
//go:generate mockgen -source namesrv.go -destination mock_namesrv.go -self_package github.com/hbgzliyan/rocketmq-client-go/v2/internal  --package internal Namesrvs
